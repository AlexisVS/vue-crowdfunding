<template>
  <div class="crowfunding-container flex flex-col justify-center space-y-6">
    <Header :openRewards="openRewards" :handleOpenRewards="handleOpenRewards" />
    <Backers :data="{ ...crowfunding.statistics }" />
    <About
      :openRewards="openRewards"
      :data="{ ...crowfunding.stands }"
      :handleOpenRewards="handleOpenRewards"
    />
    <Overlay
      @closeOverlay="handleOpenRewards"
...
<script>
import Backers from "./backers/Backers.vue";
